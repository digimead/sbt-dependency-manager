...
object Keys {
  ...
  lazy val dependencyTaskPackWithArtifact = TaskKey[Unit]("dependency-pack-with-artifact", "Fetch dependency code and source jars, add project artefact. Save results to consolidated jar.")
