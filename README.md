...
IMPORTANT. You may fetch artifacts only for those plugins that were added via ```addSbtPlugin``` as jar files. Source code of dynamicaly compiled plugins is not fetched. That is expected.
